...
class Personaje{
    ...
    colisiona(){
        if(this.x > terrenox2 || this.x < terrenox1 || this.y > terrenoy2 || this.y < terrenoy1){
            if(this.direccionisometrica == 1){this.direccionisometrica == 2}
            else if(this.direccionisometrica == 3){this.direccionisometrica == 0}
            else if(this.direccionisometrica == 0){this.direccionisometrica == 3}
            else if(this.direccionisometrica == 2){this.direccionisometrica == 1}
        }
    }
    pierdeenergia(){
        this.energia -= 1;
