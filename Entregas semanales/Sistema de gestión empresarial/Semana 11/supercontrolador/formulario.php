...
<html>
    <head>
        ...
        <style>
            ...
            #formulario{width:50%;background:white;margin:auto;margin-top:20px;padding:20px;box-shadow:0px 10px 20px rgba(0,0,0,0.4);border-radius:10px;text-align:center;}
            img{width:10%;height:10%}
            #formulario p{text-align:left;margin-bottom:5px;font-size:12px;}
