                ...
                echo '
                    <aside>
                        ...
                        while ($fila = $resultado->fetch_array()) {
                            ...
                            while ($fila2 = $resultado2->fetch_assoc()) {
                                $comment = json_decode($fila2["Comment"]);

                                if ($comment && isset($comment->titulo)) {
                                    echo '<li><a href="?tabla=' . $fila[0] . '" title="' . $comment->descripcion . '"><i class="' . $comment->icono . '"></i> ' . $comment->titulo . '</a></li>';
                                } else {
                    ...
                    <section>
                        ...
                        ';
                            ...
                            if(isset($_GET['tabla']) && (!isset($_GET['informe'])) && (!isset($_GET['delete'])) && (!isset($_GET['update'])) ){$miformulario->leer($_GET['tabla']);}
